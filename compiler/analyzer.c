...
void analyzer_init(Analyzer *a) {
    ...
    // std.tensor
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_I32); scope_define_fn(a,"tensor_1d",p,1,type_new(TY_ANY)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_I32); p[1]=type_new(TY_I32); scope_define_fn(a,"tensor_2d",p,2,type_new(TY_ANY)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); scope_define_fn(a,"tensor_free",p,1,type_new(TY_VOID)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); p[1]=type_new(TY_I32); scope_define_fn(a,"tensor_get",p,2,type_new(TY_F32)); }
    { TypeInfo **p=calloc(3,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); p[1]=type_new(TY_I32); p[2]=type_new(TY_F32); scope_define_fn(a,"tensor_set",p,3,type_new(TY_VOID)); }
    { TypeInfo **p=calloc(3,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); p[1]=type_new(TY_I32); p[2]=type_new(TY_I32); scope_define_fn(a,"tensor_get2d",p,3,type_new(TY_F32)); }
    { TypeInfo **p=calloc(4,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); p[1]=type_new(TY_I32); p[2]=type_new(TY_I32); p[3]=type_new(TY_F32); scope_define_fn(a,"tensor_set2d",p,4,type_new(TY_VOID)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); scope_define_fn(a,"tensor_size",p,1,type_new(TY_I32)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); scope_define_fn(a,"tensor_rows",p,1,type_new(TY_I32)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); scope_define_fn(a,"tensor_cols",p,1,type_new(TY_I32)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); p[1]=type_new(TY_F32); scope_define_fn(a,"tensor_fill",p,2,type_new(TY_VOID)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); scope_define_fn(a,"tensor_zeros",p,1,type_new(TY_VOID)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); scope_define_fn(a,"tensor_ones",p,1,type_new(TY_VOID)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); scope_define_fn(a,"tensor_xavier",p,1,type_new(TY_VOID)); }
    { TypeInfo **p=calloc(3,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); p[1]=type_new(TY_F32); p[2]=type_new(TY_F32); scope_define_fn(a,"tensor_randn",p,3,type_new(TY_VOID)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); p[1]=type_new(TY_ANY); scope_define_fn(a,"tensor_add",p,2,type_new(TY_ANY)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); p[1]=type_new(TY_ANY); scope_define_fn(a,"tensor_sub",p,2,type_new(TY_ANY)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); p[1]=type_new(TY_ANY); scope_define_fn(a,"tensor_mul",p,2,type_new(TY_ANY)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); p[1]=type_new(TY_F32); scope_define_fn(a,"tensor_scale",p,2,type_new(TY_ANY)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); p[1]=type_new(TY_F32); scope_define_fn(a,"tensor_add_scalar",p,2,type_new(TY_ANY)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); scope_define_fn(a,"tensor_sum",p,1,type_new(TY_F32)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); scope_define_fn(a,"tensor_mean",p,1,type_new(TY_F32)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); scope_define_fn(a,"tensor_max",p,1,type_new(TY_F32)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); scope_define_fn(a,"tensor_min",p,1,type_new(TY_F32)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); p[1]=type_new(TY_ANY); scope_define_fn(a,"tensor_matmul",p,2,type_new(TY_ANY)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); scope_define_fn(a,"tensor_transpose",p,1,type_new(TY_ANY)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); scope_define_fn(a,"tensor_relu",p,1,type_new(TY_ANY)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); scope_define_fn(a,"tensor_sigmoid",p,1,type_new(TY_ANY)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); scope_define_fn(a,"tensor_tanh_act",p,1,type_new(TY_ANY)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); scope_define_fn(a,"tensor_softmax",p,1,type_new(TY_ANY)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); scope_define_fn(a,"tensor_gelu",p,1,type_new(TY_ANY)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); p[1]=type_new(TY_ANY); scope_define_fn(a,"tensor_mse",p,2,type_new(TY_F32)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); p[1]=type_new(TY_ANY); scope_define_fn(a,"tensor_cross_entropy",p,2,type_new(TY_F32)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); p[1]=type_new(TY_ANY); scope_define_fn(a,"tensor_relu_grad",p,2,type_new(TY_ANY)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); p[1]=type_new(TY_ANY); scope_define_fn(a,"tensor_sigmoid_grad",p,2,type_new(TY_ANY)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); p[1]=type_new(TY_F32); scope_define_fn(a,"tensor_layer_norm",p,2,type_new(TY_ANY)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); p[1]=type_new(TY_ANY); scope_define_fn(a,"tensor_dot",p,2,type_new(TY_F32)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); scope_define_fn(a,"tensor_copy",p,1,type_new(TY_ANY)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); scope_define_fn(a,"tensor_print",p,1,type_new(TY_VOID)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); p[1]=type_new(TY_STR); scope_define_fn(a,"tensor_save",p,2,type_new(TY_I32)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_STR); scope_define_fn(a,"tensor_load",p,1,type_new(TY_ANY)); }
    // std.nn
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_I32); p[1]=type_new(TY_I32); scope_define_fn(a,"nn_linear_new",p,2,type_new(TY_ANY)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); p[1]=type_new(TY_ANY); scope_define_fn(a,"nn_linear_forward",p,2,type_new(TY_ANY)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); p[1]=type_new(TY_ANY); scope_define_fn(a,"nn_linear_backward",p,2,type_new(TY_ANY)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); scope_define_fn(a,"nn_linear_zero_grad",p,1,type_new(TY_VOID)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); scope_define_fn(a,"nn_linear_free",p,1,type_new(TY_VOID)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); scope_define_fn(a,"nn_linear_weights",p,1,type_new(TY_ANY)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); scope_define_fn(a,"nn_linear_bias",p,1,type_new(TY_ANY)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); scope_define_fn(a,"nn_linear_dw",p,1,type_new(TY_ANY)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); scope_define_fn(a,"nn_linear_db",p,1,type_new(TY_ANY)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); p[1]=type_new(TY_F32); scope_define_fn(a,"nn_sgd_step",p,2,type_new(TY_VOID)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); scope_define_fn(a,"nn_adam_new",p,1,type_new(TY_ANY)); }
    ...
    // std.json
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_STR); scope_define_fn(a,"json_parse",p,1,type_new(TY_ANY)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); scope_define_fn(a,"json_stringify",p,1,type_new(TY_STR)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); scope_define_fn(a,"json_free",p,1,type_new(TY_VOID)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); p[1]=type_new(TY_STR); scope_define_fn(a,"json_get_str",p,2,type_new(TY_STR)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); p[1]=type_new(TY_STR); scope_define_fn(a,"json_get_int",p,2,type_new(TY_I32)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); p[1]=type_new(TY_STR); scope_define_fn(a,"json_get_float",p,2,type_new(TY_F32)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); scope_define_fn(a,"json_array_len",p,1,type_new(TY_I32)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); p[1]=type_new(TY_I32); scope_define_fn(a,"json_array_get",p,2,type_new(TY_ANY)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); scope_define_fn(a,"json_to_str",p,1,type_new(TY_STR)); }
    { scope_define_fn(a,"json_object_new",NULL,0,type_new(TY_ANY)); }
    { scope_define_fn(a,"json_array_new",NULL,0,type_new(TY_ANY)); }
    { TypeInfo **p=calloc(3,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); p[1]=type_new(TY_STR); p[2]=type_new(TY_STR); scope_define_fn(a,"json_set_str",p,3,type_new(TY_VOID)); }
    { TypeInfo **p=calloc(3,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); p[1]=type_new(TY_STR); p[2]=type_new(TY_I32); scope_define_fn(a,"json_set_int",p,3,type_new(TY_VOID)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); p[1]=type_new(TY_ANY); scope_define_fn(a,"json_array_push",p,2,type_new(TY_VOID)); }
    // std.thread
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); scope_define_fn(a,"thread_spawn",p,1,type_new(TY_I32)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_I32); scope_define_fn(a,"thread_join",p,1,type_new(TY_VOID)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_I32); scope_define_fn(a,"thread_sleep",p,1,type_new(TY_VOID)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_I32); scope_define_fn(a,"thread_done",p,1,type_new(TY_I32)); }
    { scope_define_fn(a,"mutex_new",NULL,0,type_new(TY_ANY)); }
    ...
    // std.autograd
    { scope_define_fn(a,"ag_init",NULL,0,type_new(TY_VOID)); }
    { scope_define_fn(a,"ag_reset",NULL,0,type_new(TY_VOID)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_F32); p[1]=type_new(TY_I32); scope_define_fn(a,"ag_leaf",p,2,type_new(TY_I32)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_I32); scope_define_fn(a,"ag_val",p,1,type_new(TY_F32)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_I32); scope_define_fn(a,"ag_grad",p,1,type_new(TY_F32)); }
    { scope_define_fn(a,"ag_zero_grad",NULL,0,type_new(TY_VOID)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_I32); p[1]=type_new(TY_I32); scope_define_fn(a,"ag_add",p,2,type_new(TY_I32)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_I32); p[1]=type_new(TY_I32); scope_define_fn(a,"ag_sub",p,2,type_new(TY_I32)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_I32); p[1]=type_new(TY_I32); scope_define_fn(a,"ag_mul",p,2,type_new(TY_I32)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_I32); p[1]=type_new(TY_I32); scope_define_fn(a,"ag_div",p,2,type_new(TY_I32)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_I32); p[1]=type_new(TY_F32); scope_define_fn(a,"ag_pow",p,2,type_new(TY_I32)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_I32); scope_define_fn(a,"ag_neg",p,1,type_new(TY_I32)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_I32); scope_define_fn(a,"ag_exp",p,1,type_new(TY_I32)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_I32); scope_define_fn(a,"ag_log",p,1,type_new(TY_I32)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_I32); scope_define_fn(a,"ag_sqrt_op",p,1,type_new(TY_I32)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_I32); scope_define_fn(a,"ag_sin_op",p,1,type_new(TY_I32)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_I32); scope_define_fn(a,"ag_cos_op",p,1,type_new(TY_I32)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_I32); scope_define_fn(a,"ag_tanh_op",p,1,type_new(TY_I32)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_I32); scope_define_fn(a,"ag_relu_op",p,1,type_new(TY_I32)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_I32); scope_define_fn(a,"ag_sigmoid_op",p,1,type_new(TY_I32)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_I32); p[1]=type_new(TY_I32); scope_define_fn(a,"ag_mse",p,2,type_new(TY_I32)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_I32); scope_define_fn(a,"ag_backward",p,1,type_new(TY_VOID)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_I32); p[1]=type_new(TY_F32); scope_define_fn(a,"ag_update",p,2,type_new(TY_VOID)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_I32); scope_define_fn(a,"ag_print",p,1,type_new(TY_VOID)); }
    { TypeInfo **p=calloc(1,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); scope_define_fn(a,"ag_tensor",p,1,type_new(TY_ANY)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); p[1]=type_new(TY_ANY); scope_define_fn(a,"ag_tadd",p,2,type_new(TY_ANY)); }
    { TypeInfo **p=calloc(2,sizeof(TypeInfo*)); p[0]=type_new(TY_ANY); p[1]=type_new(TY_ANY); scope_define_fn(a,"ag_tmul",p,2,type_new(TY_ANY)); }
